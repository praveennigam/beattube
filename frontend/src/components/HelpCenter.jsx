...
const HelpCenter = () => {
  return (
    <div className="p-4 ">
      ...
      <ul className="mt-2">
        <li>
          <a href="https://impraveen.onrender.com/" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">FAQs</a> - Find answers to common questions.
        </li>
        <li>
          <a href="https://impraveen.onrender.com/" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Contact Support</a> - Get help from our support team.
        </li>
        <li>
          <a href="https://impraveen.onrender.com/" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">Community Forum</a> - Join discussions with other users and share tips.
        </li>
      </ul>
